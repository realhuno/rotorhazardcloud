...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function() {
            ...
            var socket = io.connect('http://10.0.0.81:5000');
                    ...
                    <div class='col-md-2'>
                        <div class='panel panel-default'>
                            <div class="panel-heading">
                                <h3 class="panel-title">Node ${index} 	<select id=${index}_id><?php 
...
while($row = mysqli_fetch_object($ergebnis))
{
	...
	echo "<option value=".$userid.">".$username."</option>";
            ...
            socket.on('pass_record', function(msg) {
				...
				var pilotid=document.getElementById(msg.node+"_id").value;
                ...
                append_to_log('on pass_record ' + JSON.stringify(msg));
				  ...
				  xhttp.open("GET", "db.php?timestamp="+time_lap+"&node="+msg.node+"&pilotid="+pilotid+"&lap="+(lap_table[0].children.length-1)+"&head="+headid, true);
